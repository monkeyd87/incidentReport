...
export const StudentPage = ()=>{
    ...
    const remove = async(reportId)=>{
        const response = await fetch('https://wlcpincidentreport-b83c7d609aa0.herokuapp.com/api/student/'+id+'/report/'+reportId+"/remove",{
            headers:{
    ...
    const getStudent = async()=>{
        try{
            const response = await fetch('https://wlcpincidentreport-b83c7d609aa0.herokuapp.com/api/student/'+id,{
                headers:{
                    authorization: "bearer "+token
